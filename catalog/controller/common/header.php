<?php
	class ControllerCommonHeader extends Controller {
		public function index() {
			...
			$this->document->addStyle('catalog/view/javascript/jquery/fullscreen-loader/css/jquery.loadingModal.min.css');
			$this->document->addScript('catalog/view/javascript/jquery/fullscreen-loader/js/jquery.loadingModal.min.js');

<?php if (!isset($redirect)) { ?>
		...
		<tbody>
		  ...
		  <tr>
			<td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
			  ...
			  <br />
			  &nbsp;<small> - <?php echo $option['name']; ?>: <?php echo $option['value']. ' ('.$option['price_prefix'].$option['price'].')'; ?></small>
			  <?php } ?>
  ...
  <div class="payment"><?php echo $payment; ?></div>
	<div class="pull-sm-left text-center text-sm-left">
  	<a id="quickcheckout-back" class="btn btn-primary pull-left" href="<?php echo $back; ?>"><?php echo $button_back; ?></a>
	</div>

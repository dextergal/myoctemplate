...
<?php } ?>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input type="text" name="quantity" title="<?= $minimum; ?>" onblur="minchange1(this)" class="form-control input-number integer text-center" id="input-quantity" value="<?= $minimum; ?>" >
          <span class="input-group-btn">
